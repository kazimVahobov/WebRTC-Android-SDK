...
public interface IWebRTCListener {
    ...
    /**
     * @param streamId It's called when reconnection attempt is started
     */
    void onReconnectionAttempt(String streamId);

    /**
     * It's called when joined the room
     *
     * @param streamId
    ...
    /**
     * @param streamId It's called when mic is muted for the stream
     */
    void onMutedFor(String streamId);

    /**
     * @param streamId It's called when mic is unMuted for the stream
     */
    void onUnMutedFor(String streamId);

    /**
     * @param streamId It's called when camera is turned on for the stream
     */
    void onCameraTurnOnFor(String streamId);

    /**
     * @param streamId It's called when camera is turned off for the stream
     */
     ...
     * @param streamId
     * @param micStatus
     * @param cameraStatus It's called when status of mic and camera is updated for the stream
     */
    void onStatusUpdateFor(String streamId, boolean micStatus, boolean cameraStatus);
     ...
     * @return
     */
    boolean checkAndRequestPermissions(boolean isForPublish, PermissionCallback permissionCallback);
